			...
			'config' => array(
				'providers' => [
					'Linkedin' => [
						...
						'callback' => 'https:' . getenv('BASE_URL', '') . '/auth/socialAuth?type=linkedin',
						'keys' => [
					...
					'Facebook' => [
						...
						'callback' => 'https:' . getenv('BASE_URL', '') . '/auth/socialAuth?type=facebook',
						'keys' => [
					...
					'Google' => [
						...
						'callback' => 'https:' . getenv('BASE_URL', '') . '/auth/socialAuth?type=google',
						'keys' => [
